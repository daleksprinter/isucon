...
create index jia_isu_uuid_idx on isu_condition(jia_isu_uuid);
create index timestamp_idx on isu_condition(`timestamp`);
create index idx_isu_timestamp on isu_condition(jia_isu_uuid, timestamp);
